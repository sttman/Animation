...
- (void)configFourFoldImage
{
    ...
    _one.image = [UIImage imageNamed:@"123.jpg"];
    ...
    _two.image = [UIImage imageNamed:@"123.jpg"];
    ...
    _three.image = [UIImage imageNamed:@"123.jpg"];
    ...
    _four.image = [UIImage imageNamed:@"123.jpg"];
